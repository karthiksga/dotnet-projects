...
<body>
  ...
  <script language="JavaScript" type="text/javascript">
    ...
    {
      var objType = Object.getType(obj);
      alert(objType);
      var flag = objType.implementsInterface(Department.IEmployee);
      alert(flag);
      if (!flag)
        throw Error.argument("Must implement the Department.IEmployee interface");
      return obj.get_employeeID();
    }
    ...
    Department.Manager.prototype =
    {
      ...
      getEmployeeInfo : function() {
        var info = Department.Manager.callBaseMethod(this, "getEmployeeInfo", null);
        info += ("Department: " + this._department + "\n");
        return info;
      }
    };
    ...
    mgr.set_employeeID(234);
    var employeeID = getEmployeeID(mgr);
    alert (employeeID);
  </script>
