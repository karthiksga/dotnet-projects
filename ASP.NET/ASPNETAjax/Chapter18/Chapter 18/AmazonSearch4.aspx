...
<body>
  ...
  <asp:ScriptManager runat="server" ID="ScriptManager1">
    ...
    <Services>
      <asp:ServiceReference InlineScript="true" Path="AmazonSearch4.asbx" />
    </Services>
  </asp:ScriptManager>
  <custom:AmazonSearchScriptControl runat="server" ID="MS" SearchMethod="MyServices4.AmazonService4.Search"
