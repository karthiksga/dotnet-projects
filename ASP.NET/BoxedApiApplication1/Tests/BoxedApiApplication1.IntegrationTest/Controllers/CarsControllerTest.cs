namespace BoxedApiApplication1.IntegrationTest.Controllers;
...
public class CarsControllerTest : CustomWebApplicationFactory<Program>
{
    ...
    public async Task Options_CarsRoot_Returns200OkAsync()
    {
        ...
        Assert.Equal(
            [HttpMethods.Get, HttpMethods.Head, HttpMethods.Options, HttpMethods.Post],
    ...
    public async Task Get_InvalidAcceptHeader_Returns406NotAcceptableAsync()
    {
        ...
        // response body instead. This will be fixed in .NET 7. See https://github.com/aspnet/AspNetCore/issues/16889
    }
    ...
    public async Task GetPage_Invalid_Returns400BadRequestAsync(string direction)
    {
        ...
        Assert.Equivalent(
            ...
            {
                [direction] = [$"'{direction}' must be between 1 and 20. You entered 21."],
            },
    ...
    public async Task PostCar_Invalid_Returns400BadRequestAsync()
    {
        ...
        Assert.Equivalent(
            new Dictionary<string, string[]>()
            {
                [nameof(SaveCar.Cylinders)] = ["'Cylinders' must be between 1 and 20. You entered 0."],
                [nameof(SaveCar.Make)] = ["'Make' must not be empty."],
                [nameof(SaveCar.Model)] = ["'Model' must not be empty."],
            },
            problemDetails.Errors);
    }
    ...
    public async Task PostCar_EmptyRequestBody_Returns400BadRequestAsync()
    {
        ...
        Assert.Equivalent(
            new Dictionary<string, string[]>()
            {
                [string.Empty] = ["A non-empty request body is required."],
            },
            problemDetails.Errors);
    }
    ...
    public async Task PutCar_Invalid_Returns400BadRequestAsync()
    {
        ...
        Assert.Equal(["'Cylinders' must be between 1 and 20. You entered 0."], problemDetails.Errors[nameof(SaveCar.Cylinders)]);
        Assert.Equal(["'Make' must not be empty."], problemDetails.Errors[nameof(SaveCar.Make)]);
        Assert.Equal(["'Model' must not be empty."], problemDetails.Errors[nameof(SaveCar.Model)]);
    }
