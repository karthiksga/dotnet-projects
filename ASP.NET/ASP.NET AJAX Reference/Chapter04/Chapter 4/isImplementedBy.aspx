...
<body>
  ...
  <script language="JavaScript" type="text/javascript">
    ...
    var employee = new Department.Employee("SomeFirstName", "SomeLastName");
    var flag = Department.IEmployee.isImplementedBy(employee);
    alert (flag);
    var mgr = new Department.Manager("SomeFirstName", "SomeLastName", "SomeDepartment");
    flag = Department.IEmployee.isImplementedBy(mgr);
    alert (flag);
  </script>
