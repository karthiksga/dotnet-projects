...
<head id="Head1" runat="server">
  ...
  <script type="text/javascript" language="javascript">
    ...
    function divide()
    {
      ...
      MyNamespace.MyMath.Divide({ "x" : xValue, "y" : yValue}, onSuccess, onFailure, userContext);
    }
  </script>
...
<body>
  ...
  <custom:ScriptManager runat="server" ID="CustomScriptManager2">
    <Services>
      <custom:ServiceReference InlineScript="true" Path="Math.asbx" />
    </Services>
