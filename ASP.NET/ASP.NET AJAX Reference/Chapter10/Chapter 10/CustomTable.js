...
var propertyValue =
Sys.Preview.TypeDescriptor.getProperty(dataItem, propertyName, null);
var typeName = Object.getTypeName(propertyValue);
if (typeName !== 'String' && typeName !== 'Number' &&
typeName !== 'Boolean')
{
var convertToStringMethodName =
Sys.Preview.TypeDescriptor.getAttribute(
propertyValue,
"convertToStringMethodName");
if (convertToStringMethodName)
propertyValue =
Sys.Preview.TypeDescriptor.invokeMethod(propertyValue,
convertToStringMethodName, null);
}
sb.append('<td>')
