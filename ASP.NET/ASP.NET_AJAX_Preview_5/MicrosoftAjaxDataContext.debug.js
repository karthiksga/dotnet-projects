...
Type._registerScript("MicrosoftAjaxDataContext.js", ["MicrosoftAjaxCore.js"]);
...
Sys.Data.DataContext = function Sys$Data$DataContext() {
    ...
    function Sys$Data$DataContext$fetchDeferredProperty(entity, propertyName, parameters, mergeOption, succeededCallback, failedCallback, timeout, userContext) {
        ...
        if (query && query.operation) {
            ...
            return this.fetchData(query.operation, Sys._combine(query.parameters, parameters), mergeOption, query.httpVerb || "POST", done, fail, timeout || 0, userContext);
        }
    }
    ...
    function Sys$Data$DataContext$_removeChanges(entity, linkField, addsOnly) {
        ...
        for (i = 0, l = changes.length; i < l; i++) {
            change = changes[i];
            if (                (linkField && (!addsOnly || change.action === Sys.Data.ChangeOperationType.insert) && (change.linkSource === entity || (anyField && (change.linkTarget === entity))) && (anyField || (change.linkSourceField === linkField))) ||
    ...
    function Sys$Data$DataContext$_saveInternal(dc, changes, succeededCallback, failedCallback, context) {
        ...
        return Sys.Net.WebServiceProxy.invoke(dc.get_serviceUri(),
            ...
            parameters ? Sys._combine(parameters, { changeSet: changes }) : { changeSet: changes },
            succeededCallback,
            failedCallback,
            context,
