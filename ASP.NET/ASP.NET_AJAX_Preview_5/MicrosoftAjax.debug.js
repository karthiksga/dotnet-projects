...
Sys._combine = function Sys$_combine() {
	var obj = {};
...
Number._parseNumberNegativePattern = function Number$_parseNumberNegativePattern(value, numFormat, numberNegativePattern) {
    ...
    switch (numberNegativePattern) {
        ...
        case 2:             neg += ' ';
            pos += ' ';
        case 1:             if (value.startsWith(neg)) {
            ...
            break;
        case 0:             if (value.startsWith('(') && value.endsWith(')')) {
...
(function(cultureInfo) {
    ...
    switch(typeof(cultureInfo)) {
        case "string":
                        cultureInfo = eval("(" + cultureInfo + ")");
                    case "object":
                        Sys.CultureInfo.CurrentCulture = Sys.CultureInfo._parse(cultureInfo);
