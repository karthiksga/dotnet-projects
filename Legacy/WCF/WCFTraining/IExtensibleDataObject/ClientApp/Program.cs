...
namespace ClientApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Student stud = mathService.GetStud(new Student { Name = "Test1", StudentId=1, Description = "dssds" });
            //Student stud = mathService.GetStudent(new GetStudentRequestMessage { Id = 1 });
            
            Console.WriteLine(stud.Name + ":" + stud.Description);
