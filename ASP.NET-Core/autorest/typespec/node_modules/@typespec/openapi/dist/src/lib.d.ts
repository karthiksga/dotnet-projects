export declare const $lib: import("@typespec/compiler").TypeSpecLibrary<{
    ...
    "license-url-identifier-conflict": {
        readonly default: "License 'url' and 'identifier' are mutually exclusive. Specify only one of them.";
    };
}, Record<string, any>, "tagsMetadata">;
export declare const createDiagnostic: <C extends "invalid-extension-key" | "duplicate-type-name" | "not-url" | "duplicate-tag" | "mixed-tag-metadata-form" | "tag-metadata-array-with-metadata-arg" | "tag-metadata-target-service" | "default-response-with-status-code" | "license-url-identifier-conflict", M extends keyof {
    "invalid-extension-key": {
        readonly default: import("@typespec/compiler").CallableMessage<["value"]>;
    };
    "duplicate-type-name": {
