import type { Namespace, Operation, Program, Type } from "@typespec/compiler";
import type { DefaultResponseDecorator, ExtensionDecorator, ExternalDocsDecorator, InfoDecorator, OperationIdDecorator, TagMetadataDecorator } from "../generated-defs/TypeSpec.OpenAPI.js";
 ...
 */
getOperationId: (program: Program, type: Operation) => string | undefined, 
/**
 ...
 */
setOperationId: (program: Program, type: Operation, value: string) => void;
/**
 ...
 */
export declare function setExtension(program: Program, entity: Type, extensionName: string, data: unknown): void;
/**
