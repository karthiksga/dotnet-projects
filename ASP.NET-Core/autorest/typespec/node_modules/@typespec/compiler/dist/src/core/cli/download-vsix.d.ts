 ...
 */
export declare function downloadVsixFromMarketplace(host: CliCompilerHost, extension: MarketplaceExtension, install: (vsixPath: string) => void): Promise<readonly Diagnostic[]>;
//# sourceMappingURL=download-vsix.d.ts.map