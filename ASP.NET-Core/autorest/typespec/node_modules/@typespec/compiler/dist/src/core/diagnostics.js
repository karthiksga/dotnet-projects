...
/** @internal */
export function getRelatedLocations(diagnostic) {
 ...
 */
export function getNodeForTarget(target) {
...
function getSourceLocationOfNode(node, options) {
    ...
    if (root.kind !== SyntaxKind.TypeSpecScript && root.kind !== SyntaxKind.JsSourceFile) {
        return createSyntheticSourceLocation(node.flags & NodeFlags.Synthetic
            ? undefined
 ...
 */
export function reportDeprecated(program, message, target, reportFunc) {
