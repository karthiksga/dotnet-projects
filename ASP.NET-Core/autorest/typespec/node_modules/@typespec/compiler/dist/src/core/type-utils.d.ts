...
import type { ArrayModelType, Entity, Enum, ErrorType, Interface, Model, Namespace, NeverType, Node, NullType, Operation, RecordModelType, Sym, TemplateDeclarationNode, TemplatedType, Type, TypeMapper, UnknownType, Value, VoidType } from "./types.js";
 ...
 * @param type Model type
 */
export declare function isArrayModelType(type: Model): type is ArrayModelType;
/**
 ...
 */
export declare function isRecordModelType(program: Program, type: Model): type is RecordModelType;
/**
 * Check if a model is a record type.
 * @param type Model type
 */
export declare function isRecordModelType(type: Model): type is RecordModelType;
/**
