import { ResolveModuleError } from "../module-resolver/index.js";
import type { PackageJson } from "../types/package-json.js";
import type { DiagnosticTarget, ParseOptions, SourceFile, Tracer } from "./types.js";
import { NoTarget, type CompilerHost, type Diagnostic, type JsSourceFileNode, type LocationContext, type TypeSpecScriptNode } from "./types.js";
...
export interface SourceLoader {
    importFile(path: string, diagnosticTarget: DiagnosticTarget | typeof NoTarget, locationContext?: LocationContext, kind?: "import" | "entrypoint"): Promise<void>;
...
export declare function moduleResolutionErrorToDiagnostic(e: ResolveModuleError, specifier: string, sourceTarget: DiagnosticTarget | typeof NoTarget): Diagnostic;
export {};
