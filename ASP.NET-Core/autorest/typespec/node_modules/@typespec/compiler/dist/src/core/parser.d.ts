import type { Diagnostic, Expression, IdentifierContext, IdentifierNode, ImportStatementNode, Node, ParseOptions, PositionDetail, SourceFile, TextRange, TypeReferenceNode, TypeSpecScriptNode } from "./types.js";
