...
import type { ArrayValue, BooleanValue, DiagnosticTarget, Entity, EnumValue, NullValue, NumericValue, ObjectValue, ScalarValue, StringValue, Type, Value } from "../../core/types.js";
...
export interface ValueKit {
     ...
     */
    isAssignableTo: Diagnosable<(source: Value, target: Entity, diagnosticTarget?: DiagnosticTarget) => boolean>;
    /**
     ...
     * @param diagnosticTarget Target for the diagnostic
     */
    isOfType: Diagnosable<(source: Value, target: Type, diagnosticTarget?: DiagnosticTarget) => boolean>;
    /**
