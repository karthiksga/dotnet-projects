...
export function createTypeSpecLibrary(lib) {
    ...
    compilerAssert(lib.alias === undefined || isValidLibraryAlias(lib.alias), `Library alias "${lib.alias}" for library "${lib.name}" is invalid. It must contain only lowercase letters, digits, and hyphens (e.g. "tcgc").`);
