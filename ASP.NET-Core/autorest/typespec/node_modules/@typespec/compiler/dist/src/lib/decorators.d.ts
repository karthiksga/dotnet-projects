import type { DiscriminatedDecorator, DiscriminatorDecorator, DocDecorator, EncodeDecorator, ErrorDecorator, ErrorsDocDecorator, ExampleDecorator, ExampleOptions, FormatDecorator, FriendlyNameDecorator, InspectTypeDecorator, InspectTypeNameDecorator, KeyDecorator, MaxItemsDecorator, MaxLengthDecorator, MaxValueDecorator, MaxValueExclusiveDecorator, MediaTypeHintDecorator, MinItemsDecorator, MinLengthDecorator, MinValueDecorator, MinValueExclusiveDecorator, OpExampleDecorator, OverloadDecorator, PatternDecorator, ReturnsDocDecorator, SecretDecorator, SummaryDecorator, TagDecorator, WithOptionalPropertiesDecorator, WithoutDefaultValuesDecorator, WithoutOmittedPropertiesDecorator, WithPickedPropertiesDecorator } from "../../generated-defs/TypeSpec.js";
import type { DocData } from "../core/intrinsic-type-state.js";
import type { Program } from "../core/program.js";
import type { Enum, Interface, Model, ModelProperty, Namespace, Operation, Scalar, Type, Union, Value } from "../core/types.js";
...
export declare function isDateTimeType(program: Program, target: Type): target is Scalar;
/**
 ...
 */
export declare function setMediaTypeHint(program: Program, target: MediaTypeHintable, mediaType: string): void;
/**
