...
export function isWhitespaceStringOrUndefined(str) {
    return !str || /^\s*$/.test(str);
}
export function firstNonWhitespaceCharacterIndex(line) {
    return line.search(/\S/);
}
export function distinctArray(arr, keySelector) {
    const map = new Map();
...
export function debounce(fn, delayInMs) {
    let timer;
...
export function getEnvironmentVariable(envVarName, defaultWhenNotAvailable) {
