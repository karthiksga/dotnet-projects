...
import type { AugmentDecoratorStatementNode, IdentifierNode, MemberExpressionNode, Node, NodeLinks, ResolutionResult, Sym, SymbolLinks, SymbolTable, TypeReferenceNode, UsingStatementNode } from "./types.js";
