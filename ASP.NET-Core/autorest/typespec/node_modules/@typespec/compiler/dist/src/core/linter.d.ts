...
import type { Diagnostic, DiagnosticMessages, LinterDefinition, LinterResolvedDefinition, LinterRule, LinterRuleContext, LinterRuleSet } from "./types.js";
...
export declare function createLinter(program: Program, loadLibrary: (name: string) => Promise<LinterLibraryInstance | undefined>, codeResolver?: DiagnosticCodeResolver): Linter;
export declare function createLinterRuleContext<N extends string, DM extends DiagnosticMessages, Options extends Record<string, unknown>>(program: Program, rule: LinterRule<N, DM, Options>, options: Options, diagnosticCollector: DiagnosticCollector): LinterRuleContext<DM, Options>;
