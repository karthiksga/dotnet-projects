import type { DiagnosticMessages, LinterDefinition, LinterRuleDefinition, PackageFlags, TypeSpecLibrary, TypeSpecLibraryDef } from "./types.js";
...
export declare function createLinterRule<const N extends string, const T extends DiagnosticMessages, const Options extends Record<string, unknown> = Record<string, never>>(definition: LinterRuleDefinition<N, T, Options>): LinterRuleDefinition<N, T, Options>;
/**
