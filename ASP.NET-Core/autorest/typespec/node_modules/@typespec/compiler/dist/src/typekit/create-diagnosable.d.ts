 ...
 */
export declare function createDiagnosable<P extends unknown[], R>(fn: (this: Typekit, ...args: P) => [R, readonly Diagnostic[]]): Diagnosable<(...args: P) => R>;
//# sourceMappingURL=create-diagnosable.d.ts.map