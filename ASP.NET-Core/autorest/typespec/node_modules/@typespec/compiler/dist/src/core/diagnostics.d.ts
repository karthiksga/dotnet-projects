...
import type { CodeFix, Diagnostic, DiagnosticResult, DiagnosticTarget, LogSink, Node, SourceLocation, Type, TypeSpecDiagnosticTarget } from "./types.js";
 ...
 */
export declare function getNodeForTarget(target: TypeSpecDiagnosticTarget): Node | undefined;
 ...
 */
export declare function reportDeprecated(program: Program, message: string, target: DiagnosticTarget | typeof NoTarget, reportFunc?: (diagnostic: Diagnostic) => void): void;
/**
