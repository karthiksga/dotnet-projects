 ...
 */
export function reportDeprecatedCommand(host, command, docsUrl) {
...
export function withCliHost(baseHost, fn) {
    return withFailsafe((args) => {
 ...
 */
export function withCliHostAndDiagnostics(baseHost, fn) {
    return withFailsafe(async (args) => {
        const host = createCLICompilerHost(args, baseHost);
...
export function createCLICompilerHost(options, baseHost = NodeHost) {
...
export function logInternalCompilerError(error) {
 ...
 */
export function parseCliArgsArgOption(args = []) {
    const map = {};
