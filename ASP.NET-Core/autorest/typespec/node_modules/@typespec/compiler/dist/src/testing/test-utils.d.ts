...
import type { BasicTestRunner, TestHost, TypeSpecTestLibrary, TypeSpecTestLibraryInit } from "./types.js";
 ...
 */
export declare function findTestPackageRoot(fileUrl: string): Promise<string>;
/**
 ...
 * @deprecated Use {@link createTester} instead
 */
export declare function createTestLibrary(init: TypeSpecTestLibraryInit): TypeSpecTestLibrary;
...
/** @deprecated Use {@link createTester} instead */
export declare function createTestWrapper(host: TestHost, testWrapperOptions?: TestWrapperOptions): BasicTestRunner;
export declare function trimBlankLines(code: string): string;
/**
 ...
 */
export declare function expectTypeEquals(actual: Type | undefined, expected: Type): void;
