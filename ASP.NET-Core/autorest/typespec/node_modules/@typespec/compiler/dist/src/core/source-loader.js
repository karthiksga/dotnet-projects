...
import { ModifierFlags, NodeFlags, NoTarget, SyntaxKind, } from "./types.js";
/**
...
export async function createSourceLoader(host, options) {
     ...
     */
    async function resolveLibraryFeatures(libraryRoot) {
        ...
        const features = config.diagnostics.length === 0 && config.kind === "project" ? config.features : undefined;
...
export function moduleResolutionErrorToDiagnostic(e, specifier, sourceTarget) {
    const target = e.pkgJson
        ? {
