import { createDiagnosticCollector, getLocationContext, getOverloadedOperation, getOverloads, listOperationsIn, listServices, navigateProgram, } from "@typespec/compiler";
...
export function getHttpOperation(program, operation, options) {
    if (!options) {
        return useCache(program, httpOperationCacheKey, operation, () => getHttpOperationInternal(program, operation, options, new Map()));
    }
