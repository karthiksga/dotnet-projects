...
export function createMetadataInfo(program, options) {
    ...
    let State;
    (function (State) {
        State[State["NotTransformed"] = 0] = "NotTransformed";
        State[State["Transformed"] = 1] = "Transformed";
        State[State["Emptied"] = 2] = "Emptied";
        State[State["ComputationInProgress"] = 3] = "ComputationInProgress";
    })(State || (State = {}));
    ...
    function getState(type, visibility) {
        return stateMap.getOrAdd(type, visibility, () => computeState(type, visibility), State.ComputationInProgress);
    }
