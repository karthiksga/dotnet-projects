import type { DiagnosticResult, Interface, ListOperationOptions, Model, ModelProperty, Namespace, Operation, Program, Scalar, Tuple, Type } from "@typespec/compiler";
...
export type HttpOperationParameter = HttpOperationHeaderParameter | HttpOperationCookieParameter | HttpOperationQueryParameter | HttpOperationPathParameter;
...
export type HttpPayloadBody = HttpOperationBody | HttpOperationMultipartBody | HttpOperationFileBody;
...
export type HttpOperationMultipartBody = HttpOperationMultipartBodyModel | HttpOperationMultipartBodyTuple;
