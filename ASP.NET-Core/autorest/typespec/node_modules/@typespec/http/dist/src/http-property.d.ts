import type { DiagnosticResult, Type } from "@typespec/compiler";
...
import type { CookieParameterOptions, HeaderFieldOptions, PathParameterOptions, QueryParameterOptions } from "./types.js";
export type HttpProperty = HeaderProperty | CookieProperty | ContentTypeProperty | QueryProperty | PathProperty | StatusCodeProperty | BodyProperty | BodyRootProperty | MultipartBodyProperty | BodyPropertyProperty;
 ...
 */
export declare function resolvePayloadProperties(program: Program, type: Type, visibility: Visibility, disposition: HttpPayloadDisposition, options?: GetHttpPropertyOptions): DiagnosticResult<HttpProperty[]>;
