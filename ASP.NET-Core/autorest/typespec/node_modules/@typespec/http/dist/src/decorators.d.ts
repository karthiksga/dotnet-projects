import type { DecoratorContext, Diagnostic, Interface, ModelProperty, Namespace, Operation, Program, Type } from "@typespec/compiler";
import type { BodyDecorator, BodyIgnoreDecorator, BodyRootDecorator, CookieDecorator, DeleteDecorator, GetDecorator, HeadDecorator, HeaderDecorator, MultipartBodyDecorator, PatchDecorator, PatchOptions, PathDecorator, PathOptions, PostDecorator, PutDecorator, QueryDecorator, QueryOptions, ServerDecorator, StatusCodeDecorator } from "../generated-defs/TypeSpec.Http.js";
import type { Authentication, HeaderFieldOptions, HttpStatusCodeRange, HttpStatusCodes, HttpVerb, PathParameterOptions, QueryParameterOptions } from "./types.js";
...
export declare const $cookie: CookieDecorator;
/**
 ...
 */
export declare function getCookieParamOptions(program: Program, entity: Type): QueryParameterOptions | undefined;
/**
 ...
 */
export declare function isCookieParam(program: Program, entity: Type): boolean;
declare const getQueryOptions: (program: Program, type: ModelProperty) => (QueryOptions & {
    name: string;
}) | undefined;
export declare const $query: QueryDecorator;
export declare function getQueryParamOptions(program: Program, entity: Type): QueryParameterOptions | undefined;
export declare function getQueryParamName(program: Program, entity: Type): string | undefined;
export declare function isQueryParam(program: Program, entity: Type): boolean;
declare const getPathOptions: (program: Program, type: ModelProperty) => (PathOptions & {
    name: string;
}) | undefined;
export declare const $path: PathDecorator;
export declare function getPathParamOptions(program: Program, entity: Type): PathParameterOptions | undefined;
export declare function getPathParamName(program: Program, entity: Type): string | undefined;
 ...
 */
export declare function getPatchOptions(program: Program, operation: Operation): PatchOptions | undefined;
