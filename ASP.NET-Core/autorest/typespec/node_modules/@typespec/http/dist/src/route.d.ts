import type { DiagnosticResult, Interface, Namespace, Operation, Program } from "@typespec/compiler";
import type { HttpOperation, HttpOperationParameter, HttpOperationParameters, HttpOperationPathParameter, RouteOptions, RoutePath, RouteProducer, RouteProducerResult, RouteResolutionOptions } from "./types.js";
