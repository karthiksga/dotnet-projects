...
export const createSchemaEmitter3_2 = ({ program, context, ...rest }) => {
    ...
    discriminatedUnion(union) {
        ...
        if (union.options.envelope === "none") {
            ...
            if (union.defaultVariant) {
                ...
                compilerAssert(defaultRef.kind === "code", "Unexpected default ref schema. Should be kind: code");
                discriminator.defaultMapping = defaultRef.value.$ref;
            }
            schema = {
                type: "object",
                oneOf: items,
...
//# sourceMappingURL=schema-emitter-3-2.js.map