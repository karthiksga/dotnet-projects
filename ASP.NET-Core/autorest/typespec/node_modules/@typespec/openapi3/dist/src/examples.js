...
function findResponseForExample(program, exampleValue, responses) {
    ...
    for (const statusCodeResponse of responses) {
        const openApiStatusCodes = ignoreDiagnostics(getOpenAPI3StatusCodes(program, statusCodeResponse.statusCodes, statusCodeResponse.type));
...
export function serializeExample(program, value, type) {
