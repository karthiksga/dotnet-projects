import type { EmitContext, NewLine, Program } from "@typespec/compiler";
import type { EnumStrategy, FileType, OpenAPI3EmitterOptions, OpenAPIVersion, OperationIdStrategy } from "./lib.js";
import type { OpenAPI3ServiceRecord } from "./types.js";
