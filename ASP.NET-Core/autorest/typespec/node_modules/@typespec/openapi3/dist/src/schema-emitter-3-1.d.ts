import type { EmitterOutput, Placeholder } from "@typespec/asset-emitter";
import { ObjectBuilder } from "@typespec/asset-emitter";
import type { Enum, IntrinsicScalarName, IntrinsicType, Model, ModelProperty, Scalar, Tuple, Union } from "@typespec/compiler";
...
export declare class OpenAPI31SchemaEmitter extends OpenAPI3SchemaEmitterBase<OpenAPISchema3_1> {
    ...
    protected combineRefWithConstraints(refSchema: any, constraints: Partial<OpenAPISchema3_1>): any;
